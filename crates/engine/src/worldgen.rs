...
impl WorldGenerator {
    ...
    fn sample(&self, wx: f32, wy: f32, wz: f32) -> u8 {
        let terrain_noise = fbm3d(wx * 0.04, wy * 0.06, wz * 0.04, 3, self.seed) - 0.5;
        ...
        let cave_a = fbm3d(wx * 0.12, wy * 0.12, wz * 0.12, 2, self.seed.wrapping_add(777));
        let cave_b = fbm3d(wx * 0.12, wy * 0.15, wz * 0.12, 2, self.seed.wrapping_add(1234));
