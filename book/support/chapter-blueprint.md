...
Explores the problem domain independently of the engine's specific code. Discusses industry standards, historical approaches (e.g., UE5 vs. Unity paradigms), and the fundamental challenges the subsystem must solve.

**[Number].2 [Core Architectural Design]**
Dives into the specific architecture chosen for the engine. Details the data structures, the engine/game responsibility split, and how data flows through this specific pipeline.
