...
\end{tikzpicture}
\caption{The fixed-tick edge problem. A per-frame edge (``pressed'') is visible to zero, one, or two fixed ticks depending on the frame rate. Without the intent pattern, edges can be lost (Case~2) or double-fired (Case~3).}
