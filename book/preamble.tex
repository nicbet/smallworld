...
% Quarto callouts reserve a small column for their icon. Keep that visual cue,
% but tighten only the lists inside the box so their bullets do not create a
% second, oversized indentation.
